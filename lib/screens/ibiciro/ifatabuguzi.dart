...
class Ifatabuguzi extends StatelessWidget {
      ...
      children: [
        Container(
          ...
          child: GestureDetector(
            ...
            child: Padding(
              padding: const EdgeInsets.symmetric(horizontal: 8.0, vertical: 0.05),
              child: Text(
                isUrStudent ? 'BUY NOW' : 'GURA',
  ...
  Widget _buildIncludes(BuildContext context) {
    return Container(
      padding: EdgeInsets.symmetric(
